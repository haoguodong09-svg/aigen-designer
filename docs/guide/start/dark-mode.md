...
:::tip 国际化
`AigenDesigner`从v0.9.11开始支持了暗黑模式！
...
```tsx
import { useTheme } from 'aigen-designer'
...
> 参照上面方案，可完成AigenDesigner 设计器暗黑模式，UI组件还需要参照UI官方文档完成暗黑模式切换

### Element Plus

> AigenDesigner与Element Plus暗黑模式一致，只需在 html 上添加一个名为 `dark` 的类即可
