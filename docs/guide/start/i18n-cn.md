...
注：本文档内容只是针对UI组件国际化设置说明，AigenDesigner暂时没支持国际化设置

`AigenDesigner` 目前的默认是ui组件的默认语言，如果需要调整ui使用其他语言，可以参考下面的方案。
:::
...
完成UI文档国际化基础上，添加`provideGlobalConfig`函数，完成AigenDesigner内部ElementPlus组件国际化

```tsx
import zhCn from 'element-plus/dist/locale/zh-cn.mjs'
import { provideGlobalConfig } from "@aigen-designer/element-plus";
