...
Aigen Designer 管理器模块，提供页面管理、插件管理、撤销重做等功能。

## 安装

```bash
pnpm add @aigen-designer/manager
```
...
```typescript
import { pageManager, usePageManager } from '@aigen-designer/manager';
...
```typescript
import { useRevoke } from '@aigen-designer/manager';
